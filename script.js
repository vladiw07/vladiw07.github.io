...
document.querySelector('#answer3').innerText = 'Абсолютно! Вземаме сериозно поверителността на потребителите. Всичка лична информация е кодирана и сигурно съхранявана.';

document.querySelector('#question4').innerText = 'Колко често се актуализират валутите в Конвертора на валута?';
document.querySelector('#answer4').innerText = 'Нашите обменни курсове се актуализират в реално време, гарантирайки точност за вашите преобразувания.';
